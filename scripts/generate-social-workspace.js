...
const linkedinPath = path.join(process.cwd(), 'promotions', 'linkedin_posts.md');
const mediumPath = path.join(process.cwd(), 'promotions', 'medium_articles.md');
...
blogs.forEach((blog, index) => {
  ...
  linkedinContent += `=================================================\n`;
  linkedinContent += `LINKEDIN POST ${index + 1}: ${title}\n`;
  linkedinContent += `=================================================\n\n`;
  ...
  mediumContent += `=================================================\n`;
  mediumContent += `MEDIUM SYNDICATION ${index + 1}: ${title}\n`;
  mediumContent += `=================================================\n\n`;
  ...
  mediumContent += `To explore the full technical teardown and learn how to implement these strategies, read the original guide here: ${url}\n\n\n\n`;
});

fs.writeFileSync(linkedinPath, linkedinContent);
fs.writeFileSync(mediumPath, mediumContent);

console.log('Workspace content generated successfully.');
