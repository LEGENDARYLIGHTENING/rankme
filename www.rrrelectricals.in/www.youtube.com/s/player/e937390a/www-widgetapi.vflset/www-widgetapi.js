(function() {
    ...
    r("Promise", function(a) {
        ...
        b.prototype.K = function(f) {
            ...
            typeof e == "function" ? this.O(e, f) : this.u(f)
        };
        ...
        b.prototype.B = function(f, e) {
            if (this.i != 0) throw Error("Cannot settle(" + f + ", " + e + "): Promise already settled in state" + this.i);
            this.i = f;
            this.j = e;
            this.i === 2 && this.M();
            this.C()
        ...
        b.prototype.C = function() {
            if (this.h != null) {
                for (var f = 0; f < this.h.length; ++f) k.i(this.h[f]);
                this.h = null
            }
        };
        var k = new c;
        ...
        b.race = function(f) {
            return new b(function(e, g) {
                for (var l = x(f), m = l.next(); !m.done; m = l.next()) d(m.value).D(e, g)
            })
        };
        b.all = function(f) {
            var e = x(f),
            ...
            return g.done ? d([]) : new b(function(l, m) {
                ...
                var w = [],
                    z = 0;
                do w.push(void 0), z++, d(g.value).D(u(w.length - 1), m), g = e.next(); while (!g.done)
            })
        };
        return b
    });
    ...
    r("WeakMap", function(a) {
        ...
        b.prototype.set = function(g, l) {
            ...
            h(g);
            if (!y(g, f)) throw Error("WeakMap key fail: " + g);
            g[f][this.h] = l;
            return this
        };
        b.prototype.get = function(g) {
            return d(g) && y(g, f) ? g[f][this.h] : void 0
        };
        b.prototype.has = function(g) {
            return d(g) && y(g, f) && y(g[f], this.h)
        };
        b.prototype.delete = function(g) {
            return d(g) && y(g, f) && y(g[f], this.h) ? delete g[f][this.h] : !1
        };
        return b
    });
    r("Map", function(a) {
        ...
        function d(e, g) {
            ...
            if (m && y(e[0], l))
                for (e = 0; e < m.length; e++) {
                    var u = m[e];
                    if (g !== g && u.key !== u.key || g === u.key) return {
                        id: l,
                        list: m,
                        index: e,
                        entry: u
    ...
    */
    ...
    J.prototype.addOnDisposeCallback = function(a, b) {
        this.j ? b !== void 0 ? a.call(b) : a() : (this.l || (this.l = []), b && (a = a.bind(b)), this.l.push(a))
    };
    ...
    */
    ...
    function Ka(a) {
        Ea.test(a) && (a.indexOf("&") != -1 && (a = a.replace(ya, "&amp;")), a.indexOf("<") != -1 && (a = a.replace(za, "&lt;")), a.indexOf(">") != -1 && (a = a.replace(Aa, "&gt;")), a.indexOf('"') != -1 && (a = a.replace(Ba, "&quot;")), a.indexOf("'") != -1 && (a = a.replace(Ca, "&#39;")), a.indexOf("\x00") != -1 && (a = a.replace(Da, "&#0;")));
        return a
    };
    ...
    n.G = function(a) {
        ...
        if (b) {
            var c = this.i[b];
            this.u != 0 ? (this.m.push(a), this.h[a + 1] = function() {}) : (c && na(c, a), delete this.h[a], delete this.h[a + 1], delete this.h[a + 2])
        }
        return !!b
    };
    n.H = function(a, b) {
        ...
        if (c) {
            ...
            if (this.B)
                for (k = 0; k < c.length; k++) h = c[k], La(this.h[h + 1], this.h[h + 2], d);
            else {
                this.u++;
                try {
                    for (k = 0, h = c.length; k < h && !this.j; k++) {
                        var f = c[k];
                        this.h[f + 1].apply(this.h[f + 2], d)
                    }
                } finally {
                    if (this.u--, this.m.length > 0 && this.u == 0)
                        for (; c = this.m.pop();) this.G(c)
                }
            }
            return k != 0
        }
    ...
    n.clear = function(a) {
        if (a) {
            var b = this.i[a];
            b && (b.forEach(this.G, this), delete this.i[a])
    ...
    function Ra() {
        for (var a = x(Qa), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }
    ...
    function X(a, b) {
        ...
        if (a = typeof a === "string" ? c.getElementById(a) : a) {
            ...
            if (!c) {
                ...
                d = [];
                for (var f in a) Oa(f, a[f], d);
                f = c + d.join("&");
                if (Va.yt_embedsEnableIframeSrcWithIntent) {
                    var e = e === void 0 ? Ga : e;
                    a: if (e = e === void 0 ? Ga : e, f instanceof K) e = f;
                        else {
                            for (a = 0; a < e.length; ++a)
                                if (c = e[a], c instanceof L && c.R(f)) {
                                    e = new K(f);
                                    break a
                                }
                            e = void 0
                    ...
                    if (e instanceof K)
                        if (e instanceof K) e = e.h;
                        else throw Error("");
                    else e = Ha.test(e) ? e : void 0;
                    e !== void 0 && (b.src = e);
            ...
            if (window.postMessage) {
                ...
                for (var l in V) V.hasOwnProperty(l) && Za(this, l)
            }
        }
    }
    n = X.prototype;
    ...
    function bb(a) {
        if (!a.h || !a.h.contentWindow) return !1;
        a.sendMessage({
            event: "listening"
        });
        return !0
    ...
    function $a(a, b) {
        a.C[b] || (a.C[b] = !0, ab(a, "addEventListener", [b]))
    }
    ...
    function eb(a, b) {
        if (B(b)) {
            ...
            a.playerInfo.hasOwnProperty("videoData") && (b = a.playerInfo.videoData, b.hasOwnProperty("title") && b.title ? (b = b.title, b !== a.videoTitle && (a.videoTitle = b, a.h.setAttribute("title", b))) : (a.videoTitle = "", a.h.setAttribute("title", "YouTube " + Y(a, "title"))))
        }
    }
    ...
    function fb(a, b) {
        ...
        for (var c = b.next(), d = {}; !c.done; d = {
                o: void 0
            }, c = b.next()) d.o = c.value, a[d.o] || (d.o === "getCurrentTime" ? a[d.o] = function() {
            ...
            return h
        } : Ta(d.o) ? a[d.o] = function(h) {
            return function() {
                this.playerInfo = {};
                this.v = {};
                ab(this, h.o, arguments);
                return this
            }
        }(d) : Ua(d.o) ? a[d.o] = function(h) {
            return function() {
                var k = h.o,
                    f = 0;
    ...
    function cb(a, b, c) {
        Z || (Z = {}, gb = new Set, ib.addEventListener("message", function(d) {
            a: if (gb.has(d.origin)) {
                ...
                var k = Z[h.id];
                if (k && d.origin === k.P) switch (d = k.T, d.u = !0, d.u && (E(d.m, d.sendMessage, d), d.m.length = 0), k = h.event, h = h.info, k) {
                    case "apiInfoDelivery":
                        if (B(h))
                            for (var f in h) h.hasOwnProperty(f) && (d.v[f] = h[f]);
                        break;
                    case "infoDelivery":
                        eb(d, h);
                        break;
                    case "initialDelivery":
                        B(h) && (clearInterval(d.i), d.playerInfo = {}, d.v = {}, fb(d, h.apiInterface), eb(d, h));
                        break;
    ...
    D("YT.subscribe", function(a, b, c) {
        U.subscribe(a, b, c);
        V[a] = !0;
        for (var d in T) T.hasOwnProperty(d) && Za(T[d], a)
    });
