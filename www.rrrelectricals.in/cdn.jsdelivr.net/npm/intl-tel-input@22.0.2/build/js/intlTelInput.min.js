...
(function(factory) {
    ...
    var factoryOutput = (() => {
        ...
        var x = (a, t) => {
            ...
            P = (a, t, e, i) => {
                if (t && typeof t == "object" || typeof t == "function")
                    for (let n of S(t)) !M.call(a, n) && n !== e && _(a, n, {
                        get: () => t[n],
                        enumerable: !(i = A(t, n)) || i.enumerable
                    });
                return a
            };
        var H = a => P(_({}, "__esModule", {
            value: !0
        }), a);
        var F = {};
        x(F, {
        ...
        var O = 0,
            ...
            f = a => a.replace(/\D/g, ""),
            D = (a = "") => a.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(),
            k = a => {
                let t = f(a);
                if (t.charAt(0) === "1") {
                    let e = t.substr(1, 3);
            ...
            b = class {
                ...
                _f() {
                    ...
                    t && (c += " iti--allow-dropdown"), i && (c += " iti--show-flags"), n && (c += ` ${n}`), d || (c += " iti--inline-dropdown");
                    let p = h("div", {
                        class: c
                    });
                    if (this.a.parentNode ? .insertBefore(p, this.a), t || i) {
                        ...
                        }, p), this.selectedCountry = h("button", {
                            type: "button",
                        ...
                        if (this.l = h("div", null, g), this.selectedCountryA11yText = h("span", {
                            ...
                            if (this.dropdownContent = h("div", {
                                ...
                                }, this.dropdownContent), this._g(this.p, "iti__standard"), this._p4(), o) {
                                let v = "iti iti--container";
                                d ? v += " iti--fullscreen-popup" : v += " iti--inline-dropdown", this.dropdown = h("div", {
                                    class: v
                    ...
                    if (p.appendChild(this.a), s) {
                        ...
                        m.phone && (this.hiddenInput = h("input", {
                            type: "hidden",
                            name: m.phone
                        }), p.appendChild(this.hiddenInput)), m.country && (this.hiddenInputCountry = h("input", {
                            type: "hidden",
                            name: m.country
                ...
                _g(t, e) {
                    for (let i = 0; i < t.length; i++) {
                        ...
                        let o = "";
                        this.d.showFlags && (o += `<div class='iti__flag-box'><div class='iti__flag iti__${n.iso2}'></div></div>`), o += `<span class='iti__country-name'>${n.name}</span>`, o += `<span class='iti__dial-code'>+${n.dialCode}</span>`, s.insertAdjacentHTML("beforeend", o)
                    }
                }
                _h(t = !1) {
                    ...
                    if (o && !l) this._v(s);
                        ...
                        u && this._y(u, !0) ? this._z(u) : o && l ? this._z("us") : this._z()
                    }
                    s && this._u(s)
                }
                _i() {
                ...
                _i3() {
                    this.d.utilsScript && !r.utils ? r.documentReady() ? r.loadUtils(this.d.utilsScript) : window.addEventListener("load", () => {
                ...
                _i4() {
                    r.autoCountry ? this.handleAutoCountry() : r.startedLoadingAutoCountry || (r.startedLoadingAutoCountry = !0, typeof this.d.geoIpLookup == "function" && this.d.geoIpLookup((t = "") => {
                        let e = t.toLowerCase();
                        e && this._y(e, !0) ? (r.autoCountry = e, setTimeout(() => y("handleAutoCountry"))) : (this._h(!0), y("rejectAutoCountryPromise"))
                    }, () => {
                ...
                _j() {
                    ...
                    this._a12 = s => {
                        ...
                        let o = s && s.data && /[^+0-9]/.test(s.data),
                            l = s && s.inputType === "insertFromPaste" && this.a.value;
                        if (o || l && !t ? n = !0 : /[^+0-9]/.test(this.a.value) || (n = !1), e && !n) {
                            let d = this.a.selectionStart || 0,
                                c = this.a.value.substring(0, d).replace(/[^+0-9]/g, "").length,
                        ...
                        if (s.key && s.key.length === 1 && !s.altKey && !s.ctrlKey && !s.metaKey) {
                            ...
                            if (t) {
                                let o = this.a.selectionStart === 0 && s.key === "+",
                                    l = /^[0-9]$/.test(s.key),
                                    d = o || l,
                                    u = this._6(),
                                    c = r.utils.getCoreNumber(u, this.s.iso2),
                                    p = this.maxCoreNumberLength && c.length >= this.maxCoreNumberLength;
                ...
                _p3(t, e = !1) {
                    ...
                    for (let s = 0; s < this.p.length; s++) {
                        let o = this.p[s],
                            l = D(o.name),
                            d = `+${o.dialCode}`;
                        if (e || l.includes(n) || d.includes(n) || o.iso2.includes(n)) {
                            let u = o.nodeById[this.id];
                            u && this.countryList.appendChild(u), i && (this._x(u, !1), i = !1)
                        }
                    }
                ...
                _v(t) {
                    ...
                    if (o) {
                        let u = this.q[f(o)],
                            c = u.indexOf(this.s.iso2) !== -1 && l.length <= o.length - 1;
                        if (!(n === "1" && k(l)) && !c) {
                    ...
                    } else i.charAt(0) === "+" && l.length ? d = "" : (!i || i === "+") && !this.s.iso2 && (d = this.j);
                ...
                _z(t) {
                    ...
                    if (this.s = t ? this._y(t, !1) || {} : {}, this.s.iso2 && (this.j = this.s.iso2), this.l) {
                        let o = "",
                            l = "";
                        t && i ? (o = `iti__flag iti__${t}`, l = `${this.s.name} +${this.s.dialCode}`) : (o = "iti__flag iti__globe", l = n.noCountrySelected), this.l.className = o, this.selectedCountryA11yText.textContent = l
                    }
                    if (this._z3(t, e), e) {
                        let o = this.s.dialCode ? `+${this.s.dialCode}` : "";
                        this.t.innerHTML = o;
                        let d = (this.selectedCountry.offsetWidth || this._z2()) + 8;
                        this.isRTL ? this.a.style.paddingRight = `${d}px` : this.a.style.paddingLeft = `${d}px`
                    }
                ...
                _updateMaxLength() {
                    if (this.d.strictMode && r.utils)
                        if (this.s.iso2) {
                            let t = r.utils.numberType[this.d.placeholderNumberType],
                                e = r.utils.getExampleNumber(this.s.iso2, !1, t, !0),
                                i = e;
                            for (; r.utils.isPossibleNumber(e, this.s.iso2);) i = e, e += "0";
                ...
                _0() {
                    ...
                    if (r.utils && s) {
                        let o = r.utils.numberType[e],
                            l = this.s.iso2 ? r.utils.getExampleNumber(this.s.iso2, i, o) : "";
                ...
                handleAutoCountry() {
                    this.d.initialCountry === "auto" && r.autoCountry && (this.j = r.autoCountry, this.a.value || this.setCountry(this.j), this.h())
                }
                handleUtils() {
                ...
                destroy() {
                    ...
                    e ? .parentNode ? .insertBefore(this.a, e), e ? .parentNode ? .removeChild(e), delete r.instances[this.id]
                }
                getExtension() {
                ...
                isValidNumber(t = !0) {
                    let e = this._6();
                    return /\p{L}/u.test(e) ? !1 : r.utils ? r.utils.isPossibleNumber(e, this.s.iso2, t) : null
                }
                isValidNumberPrecise() {
                    let t = this._6();
                    return /\p{L}/u.test(t) ? !1 : r.utils ? r.utils.isValidNumber(t, this.s.iso2) : null
                }
                setCountry(t) {
                    let e = t.toLowerCase();
            ...
            j = (a, t, e) => {
                ...
                i.onload = () => {
                    window.intlTelInputUtils && (r.utils = window.intlTelInputUtils, delete window.intlTelInputUtils, window.intlTelInputUtilsBackup && (window.intlTelInputUtils = window.intlTelInputUtilsBackup, delete window.intlTelInputUtilsBackup)), y("handleUtils"), t && t()
                }, i.onerror = () => {
                    y("rejectUtilsScriptPromise"), e && e()
                }, i.className = "iti-load-utils", i.async = !0, i.src = a, document.body.appendChild(i)
            },
            B = a => !r.utils && !r.startedLoadingUtilsScript ? (r.startedLoadingUtilsScript = !0, new Promise((t, e) => j(a, t, e))) : null,
            r = Object.assign((a, t) => {
                let e = new b(a, t);
                return e._init(), a.setAttribute("data-intl-tel-input-id", e.id.toString()), r.instances[e.id] = e, e
            }, {
                defaults: N,
